//-------------------------------------------------------------------------------------
package codex.xbit.api.client.gui.selector.tree;
...
//-------------------------------------------------------------------------------------
    public Tree(Debug _debug, Tab _tab, DefaultXbitTreeNode _rootNode, ClientConfiguration _clientConfiguration) {
//		super(_rootNode);
        debug = _debug;
        tab = _tab;
